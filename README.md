...
- **[KubeStellar Console kc-agent](https://github.com/kubestellar/console)** - MCP server for AI-assisted multi-cluster Kubernetes operations. Bridges AI assistants to live cluster data, enabling natural language management of pods, deployments, and CNCF ecosystem tools across multiple clusters.

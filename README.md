...
- **[KubeStellar Console kc-agent](https://github.com/kubestellar/console)** - MCP server for AI-assisted multi-cluster Kubernetes management. Bridges AI assistants to live cluster data, enabling natural language operations across edge and cloud clusters with CNCF project integrations.
